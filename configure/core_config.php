...
return array(
    ...
    'ecommerce-envios-tarifa-plana' => array(
        ...
        'config' =>  array(
            ...
            array('path' => 'ecommerce/plain-price/enabled',
                            'type' => 'select',
            ...
            array('path' => 'ecommerce/plain-price/titulo',
                    'type' => 'text',
                    'label' => 'Titulo metodo de envio',
                    'validation' => array('required' => true),
                    'value' => ''
                    ),
            array('path' => 'ecommerce/plain-price/price',
                    'type' => 'text',
                    'label' => 'Precio o porcentaje de envio',
                    'validation' => array('required' => true),
                    'value' => ''
                    ),
                    array('path' => 'ecommerce/plain-price/iva',
                    'type' => 'text',
                    'label' => 'IVA',
                    'validation' => array('required' => true),
                    'value' => ''
                    ),
              array('path' => 'ecommerce/plain-price/tipo',
                            'type' => 'select',
                    ...
                    array('path' => 'ecommerce/plain-price/dias',
                    'type' => 'text',
