...
class EcommerceDireccionesFacturacionModel  extends \Franky\Database\Mysql\objectOperations
{

  public function __construct()
  {
    parent::__construct();
    $this->from()->addTable('ecommerce_billing_address');
  }
    function getData($id='',$uid = '',$status='1',$busca ='')
    {
        $campos = array("id","uid","status","created_at","update_at","nombre","telefono","calle","numero","numeroi","cp","estado","ciudad","municipio",
            "colonia","rfc");
