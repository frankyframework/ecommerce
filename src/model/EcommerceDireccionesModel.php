...
class EcommerceDireccionesModel  extends \Franky\Database\Mysql\objectOperations
{
    ...
    {
      parent::__construct();
      $this->from()->addTable('ecommerce_shipping_address');
    }

    function getData($id='',$uid = '',$status='1',$busca ='')
    {
        $campos = array("id","uid","status","created_at","update_at","telefono","telefono_otro","calle","numero","numeroi","cp","estado","ciudad","municipio",
