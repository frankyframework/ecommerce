        ...
        if(!empty($productos_comprados['productos']))
        {
            ...
            if($MyPedido->save($MyPedidoEntity->getArrayCopy()) == REGISTRO_SUCCESS)
            {
                ...
                $campos = array(
                    ...
                    'gran_total' => getFormatoPrecio($productos_comprados['gran_total']+$data['monto_envio']-$productos_comprados['descuento'],true,DATA_STORE_CONFIG['simbolo'],DATA_STORE_CONFIG['abreviatura']),
                    'metodo_pago' =>'PayPal',
