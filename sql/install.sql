insert into `franky` (`php`, `css`, `js`, `jquery`, `permisos`, `constante`, `url`, `nombre`, `ajax`, `status`, `editable`, `modulo`) values('checkout.php','','','[\"jquery-validate\"]','[3]','CHECKOUT_ECOMMERCE','ecommerce/checkout/','Checkout','[\"base/ajax.admin.js\",\"ecommerce/ajax.paypal.js\",\"ecommerce/ajax.conekta.js\"]','1','0','ecommerce');
insert into `franky` (`php`, `css`, `js`, `jquery`, `permisos`, `constante`, `url`, `nombre`, `ajax`, `status`, `editable`, `modulo`) values('mi-cuenta/direcciones_facturacion/form.php','','','[\"jquery-validate\"]','[3]','FRM_DIRECCIONES_FACTURACION_ECOMMERCE','mi-cuenta/ecommerce/direcciones-facturacion/form/','Formulario administracion direcciones facturacion','','1','0','ecommerce');
insert into `franky` (`php`, `css`, `js`, `jquery`, `permisos`, `constante`, `url`, `nombre`, `ajax`, `status`, `editable`, `modulo`) values('mi-cuenta/direcciones_facturacion/lista.php','','','[]','[3]','ADMIN_LISTA_DIRECCIONES_FACTURACION_ECOMMERCE','mi-cuenta/ecommerce/direcciones-facturacion/','Administrar lista de direcciones facturacion','[\"base/ajax.admin.js\",\"ecommerce/ajax.admin.js\"]','1','0','ecommerce');
insert into `franky` (`php`, `css`, `js`, `jquery`, `permisos`, `constante`, `url`, `nombre`, `ajax`, `status`, `editable`, `modulo`) values('mi-cuenta/direcciones/form.php','','[\"validaciones.js\"]','[\"jquery-validate\"]','[3]','FRM_DIRECCIONES_ECOMMERCE','mi-cuenta/ecommerce/direcciones/form/','Formulario administracion direcciones','','1','0','ecommerce');
insert into `franky` (`php`, `css`, `js`, `jquery`, `permisos`, `constante`, `url`, `nombre`, `ajax`, `status`, `editable`, `modulo`) values('mi-cuenta/direcciones/lista.php','','','[]','[3]','ADMIN_LISTA_DIRECCIONES_ECOMMERCE','mi-cuenta/ecommerce/direcciones/','Administrar lista de direcciones','[\"base/ajax.admin.js\",\"ecommerce/ajax.admin.js\"]','1','0','ecommerce');
...
insert into `franky` (`php`, `css`, `js`, `jquery`, `permisos`, `constante`, `url`, `nombre`, `ajax`, `status`, `editable`, `modulo`) values('mi-cuenta/tarjetas/lista.php','','','','[3]','ADMIN_LISTA_TARJETAS_ECOMMERCE','mi-cuenta/ecommerce/tarjetas/','Mis tarjetas','[\"base/ajax.admin.js\",\"ecommerce/ajax.admin.js\"]','1','0','ecommerce');
insert into `franky` (`php`, `css`, `js`, `jquery`, `permisos`, `constante`, `url`, `nombre`, `ajax`, `status`, `editable`, `modulo`) values('mi-cuenta/tarjetas/form.php','','','[\"jquery-validate\"]','[3]','FRM_TARJETAS_ECOMMERCE','mi-cuenta/ecommerce/tarjetas/form/','Nueva tarjeta','','1','0','ecommerce');
